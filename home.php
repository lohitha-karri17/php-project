...
<body>
   <div class="container">
    <div class="nav">
     <div class="title">
    <img style="margin-top:40px;margin-left: 40px;" src="images/title.jpg" height="80px">
     </div>
     <div class="nav1">
        <ul >
            <li><a>Home</a></li>
            ...
            <li class="p4"><a href="registration.php">Get Started</a></li>
        </ul>
     </div>
    </div>
    <div class="left">
    ...
    <div class="right">
       <img src="images/student1.jpg" height="40px" width="30px">
    </div>
   </div>
</body>